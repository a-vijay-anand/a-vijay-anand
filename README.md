...
<details>
  ...
  - 🚀 Worked on **SaaS-based dashboard product development** and modern web application features
  - 🎨 Developed **responsive frontend components** and dashboard UI using modern web technologies
  - 🔐 Assisted in improving **authentication modules**, user experience, and dashboard functionalities
  - 🤝 Collaborated with the development team on **real-time project implementation** and debugging
  - 🌐 Gained hands-on experience in **full-stack web development** and SaaS product workflows
...
<details>
  ...
  - 🏭 Gained practical exposure to **industry workflow** and hardware support processes
...
|:-------:|:-----:|:----------:|
| 🚦 [**AI-Enhanced Traffic Lights**](https://github.com/a-vijay-anand) | `Python` `AI/ML` `IoT` `Embedded Systems` | AI smart traffic system • Real-time vehicle analysis • Intelligent signal optimization • Reduces urban congestion |
| 📊 [**SaaS Analytics Dashboard**](https://github.com/a-vijay-anand) | `React.js` `Node.js` `MongoDB` `Chart.js` `Tailwind CSS` | Monitors users & revenue • Interactive real-time charts • Auth & admin panel • Clean responsive UI/UX |
| ✅ [**Smart Task Manager**](https://github.com/a-vijay-anand) | `React.js` `Node.js` `Express.js` `MongoDB` `Tailwind CSS` | Full-stack MERN app • Task tracking & deadline reminders • User dashboards • Smooth interactive UI |
...
<div align="center">
  <i>💬 "Build with purpose. Learn without limits." — A Vijay Anand</i>
</div>

<br/>

<div align="center">
  <img width="100%" src="https://capsule-render.vercel.app/api?type=waving&amp;color=0:70a5fd,50:1a1b27,100:0d1117&amp;height=120&amp;section=footer&amp;animation=twinkling" />
</div>
